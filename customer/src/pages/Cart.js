        ...
        >
          ...
          <div className="flex-1 bg-white dark:bg-gray-800 rounded-2xl shadow p-6 border dark:border-white">
            ...
            {cartItems.length === 0 ? (
              ...
              cartItems.map((item) => (
                <div key={item.id} className="flex items-center justify-between border-b border-gray-300 dark:border-gray-700 py-4">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="flex items-center border rounded-lg dark:border-gray-600">
                      <button onClick={() => updateQuantity(item.id, -1)} className="p-2 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-l-lg">
                        <Minus size={18} />
                      </button>
                      <span className="px-4">{item.quantity}</span>
                      <button onClick={() => updateQuantity(item.id, 1)} className="p-2 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-r-lg">
                        <Plus size={18} />
                      </button>
                    </div>
